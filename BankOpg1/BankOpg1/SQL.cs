...
namespace BankOpg1
{
    class SQL
    {
        ...
        public SQL(string dbNavn, string dbServer, string dbUsername, string dbPassword)
        {
            this.dbNavn = dbNavn;
        ...
        public bool Open()
        {
            ...
            {
                Console.WriteLine("Der kunne ikke oprettes forbindelse til databasen.");
        ...
        public string[][] query(string SQLQuery)
        {
            ...
            for (int i = 0; i < dbRecords.Count; i++)	//for hver tupel 
            {
                ...
                for (int i2 = 0; i2 < ColumnCount; i2++)	//for hver kolonne i hver tupel
                {
